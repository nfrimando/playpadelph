...
export default function PlayerForm({ player, onClose, onSaved }: PlayerFormProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40">
      <div className="bg-white border border-line rounded-[3px] w-full max-w-[440px] mx-4 shadow-[0_8px_40px_rgba(0,0,0,.18)]">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            <label className="block text-[9px] tracking-[2.5px] uppercase text-mid mb-1.5">
              Nationality <span className="text-[#c0392b]">*</span>
            </label>
            <input type="text" value={form.nationality} onChange={set('nationality')} required
              className={inputClass} placeholder="e.g. PH, USA, JPN" />
          </div>
          ...
          <div>
            ...
            <input type="url" value={form.image_link} onChange={set('image_link')}
