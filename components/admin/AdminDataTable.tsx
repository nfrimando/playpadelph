  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-[9px] tracking-[3px] uppercase text-matcha font-semibold mb-1">
            Admin
          </p>
            ...
            {filtered.length === 0 ? (
              <tr>
                <td
                  ...
                  className="text-center py-12 text-mid text-[13px]"
                >
                  {query
              ...
              filtered.map((row) => (
                ...
                >
                  ...
                  {columns.map((col) => (
                    <td
                      key={col.key}
                      className="px-4 py-3 text-[13px] text-ink"
                    >
                      {col.render
                        ? col.render(row)
                        : String(
